...
int main(int argc, char *argv[]) {
  ...
  hsize_t start0=0, start1=1, stride2=2, block1=1;
  
  H5Sselect_hyperslab(vds_space, H5S_SELECT_SET, &start0, &stride2, &unlimited, &block1);
  H5Pset_virtual(dcpl, vds_space, "srcA.h5", "/dsetA", src_space);
  
  H5Sselect_hyperslab(vds_space, H5S_SELECT_SET, &start1, &stride2, &unlimited, &block1);
